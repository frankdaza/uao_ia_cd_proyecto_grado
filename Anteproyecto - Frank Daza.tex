...
\begin{document}
    ...
    \begin{center}
        \bfseries
        \MakeUppercase{Evaluación de la Eficiencia de Datos en una Arquitectura Híbrida CNN-VQC para el Diagnóstico de Tumores Cerebrales en Imágenes de Resonancia Magnética}\\
        \vspace{4cm}
    ...
    \vspace{-0.5cm}
    Evaluar la viabilidad y eficiencia de una arquitectura híbrida cuántico-clásica para la clasificación multiclase de tumores cerebrales por medio de MRI, comparando su desempeño frente a arquitecturas clásicas en escenarios de escasez de datos.
    ...
    \begin{enumerate}
        ...
        \item Analizar la eficiencia computacional de la propuesta en términos de tiempo de convergencia, número de parámetros entrenables y uso de recursos de simulación, comparándolos con modelos tradicionales de aprendizaje profundo.
    \end{enumerate}
   ...
   El proyecto aborda el problema desde la perspectiva del \textit{Hybrid Transfer Learning} \citep{mari2020transfer}.
    ...
    \begin{itemize}
        ...
        \item \textbf{Contribución empírica:} Caracterización cuantitativa de la relación de compromiso entre precisión, tiempo y parámetros. Caracterización cuantitativa de las compensaciones entre exactitud, tiempo computacional y número de parámetros.
    ...
    \begin{itemize}
        ...
        \item \textbf{A9. Evaluación Multimétrica:} Se calcularán métricas de desempeño que incluyan Accuracy y F1-Score, integrando de manera explícita la sensibilidad y especificidad por clase. Dado que en el diagnóstico oncológico los falsos negativos y falsos positivos conllevan implicaciones clínicas diferenciadas (ej. la omisión de un glioma vs. la identificación errónea de un tumor pituitario), este análisis por clase permitirá evaluar la fiabilidad del modelo en un contexto médico real. Asimismo, se registrará sistemáticamente el tiempo de entrenamiento y latencia de inferencia para discutir la viabilidad del modelo híbrido.
