...
\begin{document}
   ...
   El proyecto aborda el problema desde la perspectiva del \textit{Hybrid Transfer Learning} \citep{mari2020transfer}.
    ...
    \begin{table}[H]
        ...
        A12. Escritura del Documento Final & \cellcolor{blue!20}X & \cellcolor{blue!20}X & \cellcolor{blue!20}X & \cellcolor{blue!20}X & \cellcolor{blue!20}X & \cellcolor{blue!20}X & \cellcolor{blue!20}X & \cellcolor{blue!20}X \\ \hline
        \end{tabularx}
