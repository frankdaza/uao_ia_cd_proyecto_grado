...
\begin{document}
   ...
   El proyecto aborda el problema desde la perspectiva del \textit{Hybrid Transfer Learning} \citep{mari2020transfer}.
    ...
    Resultado 1: El circuito híbrido
    Resultado 2: modelos entrenados
    Resultado 3: Evaluación del desempeño
    Resultado 4: Escritura de un artículo con los resultados del proyecto
    Resultado 5: Ponencia en un evento de divulgación científica.
