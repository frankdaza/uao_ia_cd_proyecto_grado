...
\begin{document}
   ...
   El proyecto aborda el problema desde la perspectiva del \textit{Hybrid Transfer Learning} \citep{mari2020transfer}.
    ...
    \begin{itemize}
        \item \textbf{Inicialización por Bloques de Identidad:} Se inicializarán los parámetro\textbf{}s del Ansatz de forma que las capas iniciales realicen una transformación cercana a la identidad. Esto garantiza que, al inicio del entrenamiento, el circuito no colapse en un estado altamente entrelazado aleatorio que anule el gradiente.
        \item \textbf{Restricción de la Varianza de Parámetros:} En lugar de una distribución uniforme $[0, 2\pi]$, se utilizará una inicialización normal con varianza controlada, centrada en valores que favorezcan la estabilidad del gradiente en las primeras épocas.
